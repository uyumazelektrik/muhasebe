                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                        ...
                        <td class="py-4 px-6 text-center">
                            ...
                            <?php else: ?>
                                <?php 
                                    ...
                                    if ($s === 'absent') $color = 'bg-red-500/10 text-red-600 border-red-500/20';
                                    if (in_array($s, ['annual_leave', 'paid_leave', 'sick_leave'])) $color = 'bg-purple-500/10 text-purple-600 border-purple-500/20';
                                    if ($s === 'holiday') $color = 'bg-blue-500/10 text-blue-600 border-blue-500/20';
                        ...
                        <td class="py-4 px-6 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo public_url('user-transactions') . '?user_id=' . $user['id']; ?>" class="text-slate-400 hover:text-green-600 p-2 rounded-lg hover:bg-green-50 dark:hover:text-green-400 dark:hover:bg-green-500/10 transition-colors" title="Cari Kart">
                                ...
                                <form action="<?php echo public_url('api/delete-user'); ?>" method="POST" onsubmit="return confirm('Bu personeli silmek istediğinize emin misiniz?');" class="inline-block">
...
<div id="addUserModal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center backdrop-blur-sm p-4">
    <div class="bg-white dark:bg-card-dark p-6 rounded-2xl w-full max-w-md shadow-2xl border border-slate-200 dark:border-slate-800">
        ...
        <form method="POST" action="<?php echo public_url('api/add-user'); ?>" class="space-y-4">
            <label class="block">
...
<div id="editUserModal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center backdrop-blur-sm p-4">
    <div class="bg-white dark:bg-card-dark p-6 rounded-2xl w-full max-w-md shadow-2xl border border-slate-200 dark:border-slate-800">
        ...
        <form method="POST" action="<?php echo public_url('api/edit-user'); ?>" class="space-y-4">
